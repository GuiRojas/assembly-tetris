...
baixo:
  invoke TransparentBlt, hDC, 42, posY, 32, 32, memDC, 0, 0, 32, 32, TRUE
  ...
  add posY, 32
  invoke TransparentBlt, hDC, 42, posY, 32, 32, memDC, 0, 0, 32, 32, TRUE
  invoke TransparentBlt, hDC, 74, posY, 32, 32, memDC, 0, 0, 32, 32, TRUE
...
esquerda:
  ...
  add posY, 32
  invoke TransparentBlt, hDC, 10, posY, 32, 32, memDC, 0, 0, 32, 32, TRUE
  invoke TransparentBlt, hDC, 42, posY, 32, 32, memDC, 0, 0, 32, 32, TRUE
  invoke TransparentBlt, hDC, 74, posY, 32, 32, memDC, 0, 0, 32, 32, TRUE
